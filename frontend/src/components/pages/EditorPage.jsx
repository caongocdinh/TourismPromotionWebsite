...
import { LocationProvider, LocationSelector } from '../editor/LocationSelector'; // Sửa cách import
...
const EditorPage = () => {
  ...
  const handlePublish = useCallback(async () => {
    ...
    try {
      ...
      toast.success(response.data.message || 'Bài viết đã được gửi đến quản trị viên để duyệt!', { position: 'top-right' });
      setTitle('');
