...
const PostsView = ({ token, setEditingPost }) => {
  ...
  const [viewImagesPostId, setViewImagesPostId] = useState(null);
              ...
              <tr key={post.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => setViewImagesPostId(post.id)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg max-w-2xl w-full p-4 relative">
            <button
              ...
              onClick={() => setViewImagesPostId(null)}
              title="Đóng"
            >
              ×
            </button>
            <AdminPostImages postId={viewImagesPostId} />
          </div>
        </div>
      )}
    </div>
