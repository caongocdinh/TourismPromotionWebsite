...
// Component nhỏ cho phép nhập postId và hiển thị AdminPostImages
const PostImagesTab = () => {
  ...
  return (
    <div>
      ...
      {selectedPostId && <AdminPostImages postId={selectedPostId} />}
    </div>
  );
};
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1">
        ...
        <main className="p-6 max-w-6xl mx-auto">
          ...
          {activeTab === "images" && (
            <div>
              <h2 className="text-xl font-bold mb-4">Quản lý ảnh bài viết</h2>
              <PostImagesTab />
            </div>
          )}
        </main>
